...
*/
export class AccountBase extends null<String, any> {
    /**
    ...
    */
    'verificationStatus'?: AccountBase.VerificationStatusEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "AccountBase.VerificationStatusEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(AccountBase.attributeTypeMap);
    }
}
