...
*/
export class SandboxProcessorTokenCreateResponse extends null<String, any> {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SandboxProcessorTokenCreateResponse.attributeTypeMap);
    }
}
