...
*/
export class TransferRepaymentListResponse extends null<String, any> {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(TransferRepaymentListResponse.attributeTypeMap);
    }
}
