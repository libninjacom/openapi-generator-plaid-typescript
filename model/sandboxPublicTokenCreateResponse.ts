...
*/
export class SandboxPublicTokenCreateResponse extends null<String, any> {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SandboxPublicTokenCreateResponse.attributeTypeMap);
    }
}
