...
*/
export class DepositSwitchAltCreateResponse extends null<String, any> {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(DepositSwitchAltCreateResponse.attributeTypeMap);
    }
}
