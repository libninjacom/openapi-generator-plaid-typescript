...
*/
export class BankTransferSweepGetResponse extends null<String, any> {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BankTransferSweepGetResponse.attributeTypeMap);
    }
}
