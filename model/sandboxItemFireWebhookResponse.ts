...
*/
export class SandboxItemFireWebhookResponse extends null<String, any> {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SandboxItemFireWebhookResponse.attributeTypeMap);
    }
}
