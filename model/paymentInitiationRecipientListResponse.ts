...
*/
export class PaymentInitiationRecipientListResponse extends null<String, any> {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PaymentInitiationRecipientListResponse.attributeTypeMap);
    }
}
