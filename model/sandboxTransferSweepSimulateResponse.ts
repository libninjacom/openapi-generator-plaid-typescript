...
*/
export class SandboxTransferSweepSimulateResponse extends null<String, any> {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SandboxTransferSweepSimulateResponse.attributeTypeMap);
    }
}
