...
*/
export class AccountBalance extends null<String, any> {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "baseName": "last_updated_datetime",
            "type": "Date"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(AccountBalance.attributeTypeMap);
    }
}
