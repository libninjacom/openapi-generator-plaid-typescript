...
*/
export class BankTransferBalanceGetResponse extends null<String, any> {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BankTransferBalanceGetResponse.attributeTypeMap);
    }
}
