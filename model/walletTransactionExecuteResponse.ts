...
*/
export class WalletTransactionExecuteResponse extends null<String, any> {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WalletTransactionExecuteResponse.attributeTypeMap);
    }
}
