...
*/
export class EmploymentVerificationGetResponse extends null<String, any> {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(EmploymentVerificationGetResponse.attributeTypeMap);
    }
}
