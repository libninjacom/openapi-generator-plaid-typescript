...
*/
export class IncomeVerificationCreateResponse extends null<String, any> {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IncomeVerificationCreateResponse.attributeTypeMap);
    }
}
